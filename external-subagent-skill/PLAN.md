...
- [x] Rebind the canonical Oracle identity to the owner-selected ordinary Chrome root / `Profile 173`, using safe attach-running without copying cookies or profile state; keep `legacy-electron` explicit-only.
...
- [x] Pin the canonical Oracle donor to source commit `272e74ee977ecb1d8d21b2f779d9198ccbce85f2` and executable SHA-256 `8464b53e6a65c5a4a3d8ba159be034b8a42411c0a5d2a490eb53b525dcda78d1`; fail before spawn on mismatch.
